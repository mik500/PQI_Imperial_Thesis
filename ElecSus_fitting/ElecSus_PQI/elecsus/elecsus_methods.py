...
def fit_data(data, p_dict, p_dict_bools, groundPop, E_in=None, p_dict_bounds=None, data_type='S0', fit_algorithm='ML', **kw):
    ...
    *** Example use cases can be found in /tests/fitting_tests.py
    ...
    if fit_algorithm in ('ML', 'Marquardt-Levenberg', 'LM', 'leastsq'):
        ...
        optParams_DE, result = ML.ML_fit(data, E_in, p_dict, p_dict_bools, groundPop, p_dict_bounds=p_dict_bounds,
        ...
        optParams, result = ML.ML_fit(data, E_in, optParams_DE, p_dict_bools, groundPop, p_dict_bounds=p_dict_bounds,
                                      data_type=data_type)
    else:
