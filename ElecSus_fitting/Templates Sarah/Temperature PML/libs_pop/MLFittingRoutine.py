...
def fit_function(x,E_x,E_y,E_phase,T,lcell,Bfield,Btheta,Bphi,GammaBuf,shift, groundPop, popShift,
	...
	p_dict = {'Elem':Elem,'Dline':Dline,'T':T,'lcell':lcell,
			...
			'rb85frac':rb85frac,'K40frac':K40frac,'K41frac':K41frac, 'popShift':popShift}
	
	#for key in p_dict.keys():
	#	print key, p_dict[key]
	outputs = [output]
	
	y_out = get_spectra(x,E_in,p_dict, groundPop, popShift, outputs)[0].real
