...
def FreqStren(groundLevels,excitedLevels,groundDim,
			  excitedDim,groundPop,Dline,hand,BoltzmannFactor=True,T=293.16):
	""" 
	...
	if len(groundPop) != groundDim:
		# Raise error
		raise ValueError('Ground population vector must have length equal to the number of ground states')
