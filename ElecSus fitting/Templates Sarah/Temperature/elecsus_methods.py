...
from elecsus.libs import SAFittingRoutine as SA
from elecsus.libs import RRFittingRoutine as RR

if os.name == 'posix':
	from time import time as timing #Timing for linux or apple
else:
	from time import perf_counter as timing #Timing for windows
