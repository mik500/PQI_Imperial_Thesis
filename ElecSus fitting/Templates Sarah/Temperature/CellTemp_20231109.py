...
folder = cwd[:-22]+'Data\\VapourTemperature\\2023-11-09-CellTemperature\\'

filename = '20231109_OD.csv'
...
peak_points, _ = find_peaks(OD, prominence=0.01, distance=20)
print(peak_points)
...
y_data_cell_bg = 0.93*(y_data_cell/bg)/max(y_data_cell/bg)
