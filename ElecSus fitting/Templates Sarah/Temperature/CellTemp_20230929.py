...
folder = cwd[:-22]+'Data\\VapourTemperature\\2023-09-29-CellTemperature\\'

filename = '20230929Temp130.csv'
...
peak_points, _ = find_peaks(OD, prominence=0.05, distance=30)
print(peak_points)
plt.plot(OD)
...
w1=2.8 #using two widths here, firstly at edges of plot, and secondly in the centre
w2=1.2
...
y_data_cell_bg = (y_data_cell/bg-0.013)/max(y_data_cell/bg-0.013)
